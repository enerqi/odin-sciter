...
`just example-tests` runs 387 `@(test)` procs, and the twelve guides in `docs/` are written. Coverage of
the wrapper is 385 of its 385 exported procedures called from a test. The five that closed that gap -
