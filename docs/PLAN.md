...
`just example-tests` runs 376 `@(test)` procs, and the eleven guides in `docs/` are written. Coverage of
the wrapper is 378 of its 383 exported procedures called from a test; the rest are proc-group members
